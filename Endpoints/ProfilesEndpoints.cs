...
public static class ProfilesEndpoints
{
        ...
        this IEndpointRouteBuilder app)
    {
        ...
        //
        // Passwords are generated by the API when they are not
        ...
        group.MapPost(
                ...
                ClaimsPrincipal userClaims) =>
            {
                ...
                try
                {
                    ...
                    // Return the profile together with the temporary
                    // password so the administrator can give it to
                    // the newly created foreman.
        ...
        group.MapPatch(
                ...
                ClaimsPrincipal userClaims) =>
            {
                ...
                // Supabase Auth, not public.profiles.
